package com.example.notetaker.DataAccessBase;
...
import com.example.notetaker.Note;
...
public class DatabaseManager
{
	...
	// These constants are specific to the database.  They should be changed to suit your needs.
	private final String DB_NAME = "NoteTaker";
	private final int DB_VERSION = 1;
 
	// These constants are specific to the database table.  They should be changed to suit your needs.
	private final String TABLE_NAME = "Note";
	private final String TABLE_ROW_ID = "Id";
	private final String TABLE_ROW_ONE = "Title";
	private final String TABLE_ROW_TWO = "NoteDescription";
	private final String TABLE_ROW_THREE = "DateCreated";
	...
	public List<Note> getAllRowsAsArrays()
	{
		// create an List that will hold all of the data collected from the database.
		...
		try
		{
			...
			if (!cursor.isAfterLast())
			{
				do
				{
					notes.add(new Note(cursor.getInt(0),cursor.getString(1), cursor.getString(2), new Date()));
				}
	...
	private class CustomSQLiteOpenHelper extends SQLiteOpenHelper
	{
		public CustomSQLiteOpenHelper(Context context)
		{
			...
			Log.i(this.getClass().getName(),"CustomSQLiteOpenHelper");
		}
